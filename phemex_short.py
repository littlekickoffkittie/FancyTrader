...
def analyse(ticker: dict, cfg: dict, enable_ai: bool = True, enable_entity: bool = True,
    ...
    try:
        ...
        rsi_1h = None
        best_bid, best_ask, spread, bid_d, ask_d = None, None, 0.0, 0.0, 0.0
        ...
        if pre_score >= PRE_SCORE_THRESHOLD:
            ...
            best_bid, best_ask, spread, bid_d, ask_d = pc.get_order_book(symbol, rps=cfg.get("RATE_LIMIT_RPS"))
        ...
        regime, _ = pc.calc_market_regime(closes)
